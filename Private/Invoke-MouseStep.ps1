function Invoke-MouseStep {
    ...
    Process {
        ...
        switch ($Step.Action) {
            ...
            'Click' { Send-Click -X $Step.X -Y $Step.Y -clicks $Step.Clicks -stationary $Step.Stationary }
            'RightClick' { Send-RightClick -X $Step.X -Y $Step.Y -clicks $Step.Clicks -stationary $Step.Stationary }
            'MiddleClick' { Send-MiddleClick -X $Step.X -Y $Step.Y -clicks $Step.Clicks -stationary $Step.Stationary }
            'DoubleClick' { Send-DoubleClick -X $Step.X -Y $Step.Y -clicks $Step.Clicks -stationary $Step.Stationary }
